...
#
# Generated by export_simulation on Thu Oct 23 11:31:26 CEST 2025
#
################################################################################
...
'-reset_run' switch to the './sd_fec_0.sh' script.

./sd_fec_0.sh -reset_run
...
./sd_fec_0.sh -noclean_files

For more information on the script, please type './sd_fec_0.sh -help'.
