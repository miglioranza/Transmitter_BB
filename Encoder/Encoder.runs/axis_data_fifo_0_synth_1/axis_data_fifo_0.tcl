...
namespace eval ::optrace {
  variable script "/ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.runs/axis_data_fifo_0_synth_1/axis_data_fifo_0.tcl"
...
set cacheID [config_ip_cache -export -no_bom  -dir /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.runs/axis_data_fifo_0_synth_1 -new_name axis_data_fifo_0 -ip [get_ips axis_data_fifo_0]]
...
if { [catch {
  file copy -force /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.runs/axis_data_fifo_0_synth_1/axis_data_fifo_0.dcp /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/axis_data_fifo_0/axis_data_fifo_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/axis_data_fifo_0/axis_data_fifo_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/axis_data_fifo_0/axis_data_fifo_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/axis_data_fifo_0/axis_data_fifo_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/axis_data_fifo_0/axis_data_fifo_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.runs/axis_data_fifo_0_synth_1/axis_data_fifo_0_stub.v /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/axis_data_fifo_0/axis_data_fifo_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.runs/axis_data_fifo_0_synth_1/axis_data_fifo_0_stub.vhdl /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/axis_data_fifo_0/axis_data_fifo_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.runs/axis_data_fifo_0_synth_1/axis_data_fifo_0_sim_netlist.v /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/axis_data_fifo_0/axis_data_fifo_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.runs/axis_data_fifo_0_synth_1/axis_data_fifo_0_sim_netlist.vhdl /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/axis_data_fifo_0/axis_data_fifo_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.ip_user_files/ip/axis_data_fifo_0]} {
  catch { 
    file copy -force /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/axis_data_fifo_0/axis_data_fifo_0_stub.v /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.ip_user_files/ip/axis_data_fifo_0
  }
}

if {[file isdir /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.ip_user_files/ip/axis_data_fifo_0]} {
  catch { 
    file copy -force /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/axis_data_fifo_0/axis_data_fifo_0_stub.vhdl /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.ip_user_files/ip/axis_data_fifo_0
  }
}
