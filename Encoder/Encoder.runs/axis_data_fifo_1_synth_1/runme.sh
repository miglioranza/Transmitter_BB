...
HD_PWD='/ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.runs/axis_data_fifo_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axis_data_fifo_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axis_data_fifo_1.tcl
