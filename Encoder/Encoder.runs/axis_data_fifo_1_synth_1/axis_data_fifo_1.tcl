...
namespace eval ::optrace {
  variable script "/ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.runs/axis_data_fifo_1_synth_1/axis_data_fifo_1.tcl"
...
OPTRACE "axis_data_fifo_1_synth_1" START { ROLLUP_AUTO }
...
set_property webtalk.parent_dir /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.cache/wt [current_project]
set_property parent.project_path /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.xpr [current_project]
set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
set_property default_lib xil_defaultlib [current_project]
set_property target_language VHDL [current_project]
set_property board_part xilinx.com:zcu111:part0:1.4 [current_project]
set_property ip_repo_paths /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.srcs [current_project]
update_ip_catalog
set_property ip_output_repo /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.cache/ip [current_project]
...
set cacheID [config_ip_cache -export -no_bom  -dir /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.runs/axis_data_fifo_1_synth_1 -new_name axis_data_fifo_1 -ip [get_ips axis_data_fifo_1]]
...
synth_design -top axis_data_fifo_1 -part xczu28dr-ffvg1517-2-e -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix axis_data_fifo_1_ axis_data_fifo_1.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ axis_data_fifo_1_stub.v
 lappend ipCachedFiles axis_data_fifo_1_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ axis_data_fifo_1_stub.vhdl
 lappend ipCachedFiles axis_data_fifo_1_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ axis_data_fifo_1_sim_netlist.v
 lappend ipCachedFiles axis_data_fifo_1_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ axis_data_fifo_1_sim_netlist.vhdl
 lappend ipCachedFiles axis_data_fifo_1_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp axis_data_fifo_1.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips axis_data_fifo_1]
 }
...
create_report "axis_data_fifo_1_synth_1_synth_report_utilization_0" "report_utilization -file axis_data_fifo_1_utilization_synth.rpt -pb axis_data_fifo_1_utilization_synth.pb"
OPTRACE "synth reports" END { }

if { [catch {
  file copy -force /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.runs/axis_data_fifo_1_synth_1/axis_data_fifo_1.dcp /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/axis_data_fifo_1/axis_data_fifo_1.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/axis_data_fifo_1/axis_data_fifo_1_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/axis_data_fifo_1/axis_data_fifo_1_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/axis_data_fifo_1/axis_data_fifo_1_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/axis_data_fifo_1/axis_data_fifo_1_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.runs/axis_data_fifo_1_synth_1/axis_data_fifo_1_stub.v /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/axis_data_fifo_1/axis_data_fifo_1_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.runs/axis_data_fifo_1_synth_1/axis_data_fifo_1_stub.vhdl /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/axis_data_fifo_1/axis_data_fifo_1_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.runs/axis_data_fifo_1_synth_1/axis_data_fifo_1_sim_netlist.v /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/axis_data_fifo_1/axis_data_fifo_1_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.runs/axis_data_fifo_1_synth_1/axis_data_fifo_1_sim_netlist.vhdl /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/axis_data_fifo_1/axis_data_fifo_1_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.ip_user_files/ip/axis_data_fifo_1]} {
  catch { 
    file copy -force /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/axis_data_fifo_1/axis_data_fifo_1_stub.v /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.ip_user_files/ip/axis_data_fifo_1
  }
}

if {[file isdir /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.ip_user_files/ip/axis_data_fifo_1]} {
  catch { 
    file copy -force /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/axis_data_fifo_1/axis_data_fifo_1_stub.vhdl /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.ip_user_files/ip/axis_data_fifo_1
  }
}
file delete __synthesis_is_running__
close [open __synthesis_is_complete__ w]
OPTRACE "axis_data_fifo_1_synth_1" END { }
