...
namespace eval ::optrace {
  variable script "/ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.runs/sd_fec_0_synth_1/sd_fec_0.tcl"
...
OPTRACE "sd_fec_0_synth_1" START { ROLLUP_AUTO }
...
set cacheID [config_ip_cache -export -no_bom  -dir /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.runs/sd_fec_0_synth_1 -new_name sd_fec_0 -ip [get_ips sd_fec_0]]
...
synth_design -top sd_fec_0 -part xczu28dr-ffvg1517-2-e -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix sd_fec_0_ sd_fec_0.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ sd_fec_0_stub.v
 lappend ipCachedFiles sd_fec_0_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ sd_fec_0_stub.vhdl
 lappend ipCachedFiles sd_fec_0_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ sd_fec_0_sim_netlist.v
 lappend ipCachedFiles sd_fec_0_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ sd_fec_0_sim_netlist.vhdl
 lappend ipCachedFiles sd_fec_0_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp sd_fec_0.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips sd_fec_0]
 }
...
rename_ref -prefix_all sd_fec_0_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef sd_fec_0.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "sd_fec_0_synth_1_synth_report_utilization_0" "report_utilization -file sd_fec_0_utilization_synth.rpt -pb sd_fec_0_utilization_synth.pb"
OPTRACE "synth reports" END { }

if { [catch {
  file copy -force /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.runs/sd_fec_0_synth_1/sd_fec_0.dcp /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/sd_fec_0/sd_fec_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/sd_fec_0/sd_fec_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/sd_fec_0/sd_fec_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/sd_fec_0/sd_fec_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/sd_fec_0/sd_fec_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.runs/sd_fec_0_synth_1/sd_fec_0_stub.v /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/sd_fec_0/sd_fec_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.runs/sd_fec_0_synth_1/sd_fec_0_stub.vhdl /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/sd_fec_0/sd_fec_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.runs/sd_fec_0_synth_1/sd_fec_0_sim_netlist.v /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/sd_fec_0/sd_fec_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.runs/sd_fec_0_synth_1/sd_fec_0_sim_netlist.vhdl /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/sd_fec_0/sd_fec_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.ip_user_files/ip/sd_fec_0]} {
  catch { 
    file copy -force /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/sd_fec_0/sd_fec_0_stub.v /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.ip_user_files/ip/sd_fec_0
  }
}

if {[file isdir /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.ip_user_files/ip/sd_fec_0]} {
  catch { 
    file copy -force /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.gen/sources_1/ip/sd_fec_0/sd_fec_0_stub.vhdl /ihp/departments/D-SYA/work/miglioranza/Encoder/Encoder.ip_user_files/ip/sd_fec_0
  }
}
file delete __synthesis_is_running__
close [open __synthesis_is_complete__ w]
OPTRACE "sd_fec_0_synth_1" END { }
