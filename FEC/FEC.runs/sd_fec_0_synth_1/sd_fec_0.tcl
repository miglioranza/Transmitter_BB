...
namespace eval ::optrace {
  variable script "/home/miglioranza/FEC/FEC.runs/sd_fec_0_synth_1/sd_fec_0.tcl"
...
set cacheID [config_ip_cache -export -no_bom  -dir /home/miglioranza/FEC/FEC.runs/sd_fec_0_synth_1 -new_name sd_fec_0 -ip [get_ips sd_fec_0]]
...
if { [catch {
  file copy -force /home/miglioranza/FEC/FEC.runs/sd_fec_0_synth_1/sd_fec_0.dcp /home/miglioranza/FEC/FEC.gen/sources_1/ip/sd_fec_0/sd_fec_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub /home/miglioranza/FEC/FEC.gen/sources_1/ip/sd_fec_0/sd_fec_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub /home/miglioranza/FEC/FEC.gen/sources_1/ip/sd_fec_0/sd_fec_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim /home/miglioranza/FEC/FEC.gen/sources_1/ip/sd_fec_0/sd_fec_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim /home/miglioranza/FEC/FEC.gen/sources_1/ip/sd_fec_0/sd_fec_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force /home/miglioranza/FEC/FEC.runs/sd_fec_0_synth_1/sd_fec_0_stub.v /home/miglioranza/FEC/FEC.gen/sources_1/ip/sd_fec_0/sd_fec_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/miglioranza/FEC/FEC.runs/sd_fec_0_synth_1/sd_fec_0_stub.vhdl /home/miglioranza/FEC/FEC.gen/sources_1/ip/sd_fec_0/sd_fec_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/miglioranza/FEC/FEC.runs/sd_fec_0_synth_1/sd_fec_0_sim_netlist.v /home/miglioranza/FEC/FEC.gen/sources_1/ip/sd_fec_0/sd_fec_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/miglioranza/FEC/FEC.runs/sd_fec_0_synth_1/sd_fec_0_sim_netlist.vhdl /home/miglioranza/FEC/FEC.gen/sources_1/ip/sd_fec_0/sd_fec_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir /home/miglioranza/FEC/FEC.ip_user_files/ip/sd_fec_0]} {
  catch { 
    file copy -force /home/miglioranza/FEC/FEC.gen/sources_1/ip/sd_fec_0/sd_fec_0_stub.v /home/miglioranza/FEC/FEC.ip_user_files/ip/sd_fec_0
  }
}

if {[file isdir /home/miglioranza/FEC/FEC.ip_user_files/ip/sd_fec_0]} {
  catch { 
    file copy -force /home/miglioranza/FEC/FEC.gen/sources_1/ip/sd_fec_0/sd_fec_0_stub.vhdl /home/miglioranza/FEC/FEC.ip_user_files/ip/sd_fec_0
  }
}
