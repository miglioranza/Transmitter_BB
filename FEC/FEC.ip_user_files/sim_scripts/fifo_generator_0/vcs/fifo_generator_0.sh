...
#
# Generated by Vivado on Wed Feb 05 15:09:32 CET 2025
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"/ihpusr/xilinx/vivado2021.2/Vivado/2021.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"/ihpusr/xilinx/vivado2021.2/Vivado/2021.2/data/xilinx_vip/include" \
  ...
  vlogan -work fifo_generator_v13_2_6 $vlogan_opts +v2k +incdir+"/ihpusr/xilinx/vivado2021.2/Vivado/2021.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/ihpusr/xilinx/vivado2021.2/Vivado/2021.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../FEC.gen/sources_1/ip/fifo_generator_0/sim/fifo_generator_0.v" \
  2>&1 | tee -a vlogan.log
