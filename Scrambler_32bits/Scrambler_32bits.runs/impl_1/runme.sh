...
HD_PWD='/ihp/departments/D-SYA/work/miglioranza/Scrambler_32bits/Scrambler_32bits.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Scrambler_32bits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Scrambler_32bits.tcl -notrace
