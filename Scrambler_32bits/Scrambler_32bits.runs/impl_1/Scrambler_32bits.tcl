...
namespace eval ::optrace {
  variable script "/ihp/departments/D-SYA/work/miglioranza/Scrambler_32bits/Scrambler_32bits.runs/impl_1/Scrambler_32bits.tcl"
...
set rc [catch {
  ...
  set_param synth.incrementalSynthesisCache ./.Xil/Vivado-1111716-uxsrv005/incrSyn
  reset_param project.defaultXPMLibraries 
  open_checkpoint /ihp/departments/D-SYA/work/miglioranza/Scrambler_32bits/Scrambler_32bits.runs/impl_1/Scrambler_32bits.dcp
...
OPTRACE "Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force Scrambler_32bits_opt.dcp
OPTRACE "Opt Design: write_checkpoint" END { }
OPTRACE "opt_design reports" START { REPORT }
  create_report "impl_1_opt_report_drc_0" "report_drc -file Scrambler_32bits_drc_opted.rpt -pb Scrambler_32bits_drc_opted.pb -rpx Scrambler_32bits_drc_opted.rpx"
...
OPTRACE "Place Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force Scrambler_32bits_placed.dcp
OPTRACE "Place Design: write_checkpoint" END { }
OPTRACE "place_design reports" START { REPORT }
  create_report "impl_1_place_report_io_0" "report_io -file Scrambler_32bits_io_placed.rpt"
  create_report "impl_1_place_report_utilization_0" "report_utilization -file Scrambler_32bits_utilization_placed.rpt -pb Scrambler_32bits_utilization_placed.pb"
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file Scrambler_32bits_control_sets_placed.rpt"
...
OPTRACE "Route Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force Scrambler_32bits_routed.dcp
OPTRACE "Route Design: write_checkpoint" END { }
OPTRACE "route_design reports" START { REPORT }
  create_report "impl_1_route_report_drc_0" "report_drc -file Scrambler_32bits_drc_routed.rpt -pb Scrambler_32bits_drc_routed.pb -rpx Scrambler_32bits_drc_routed.rpx"
  create_report "impl_1_route_report_methodology_0" "report_methodology -file Scrambler_32bits_methodology_drc_routed.rpt -pb Scrambler_32bits_methodology_drc_routed.pb -rpx Scrambler_32bits_methodology_drc_routed.rpx"
  create_report "impl_1_route_report_power_0" "report_power -file Scrambler_32bits_power_routed.rpt -pb Scrambler_32bits_power_summary_routed.pb -rpx Scrambler_32bits_power_routed.rpx"
  create_report "impl_1_route_report_route_status_0" "report_route_status -file Scrambler_32bits_route_status.rpt -pb Scrambler_32bits_route_status.pb"
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file Scrambler_32bits_timing_summary_routed.rpt -pb Scrambler_32bits_timing_summary_routed.pb -rpx Scrambler_32bits_timing_summary_routed.rpx -warn_on_violation "
  create_report "impl_1_route_report_incremental_reuse_0" "report_incremental_reuse -file Scrambler_32bits_incremental_reuse_routed.rpt"
  create_report "impl_1_route_report_clock_utilization_0" "report_clock_utilization -file Scrambler_32bits_clock_utilization_routed.rpt"
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file Scrambler_32bits_bus_skew_routed.rpt -pb Scrambler_32bits_bus_skew_routed.pb -rpx Scrambler_32bits_bus_skew_routed.rpx"
...
if {$rc} {
  write_checkpoint -force Scrambler_32bits_routed_error.dcp
