...
HD_PWD='/ihp/departments/D-SYA/work/miglioranza/Scrambler_32bits/Scrambler_32bits.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Scrambler_32bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Scrambler_32bits.tcl
