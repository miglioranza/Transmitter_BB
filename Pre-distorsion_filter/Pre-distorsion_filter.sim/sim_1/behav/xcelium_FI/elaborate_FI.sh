...
fi_opts="-fault_dbg -fault_top Parallel_FIR_filter_TB -fault_overwrite -fault_file ./fault_list"

# run elaboration
$bin_path/xmelab $xmelab_opts $design_libs_elab $fi_opts xil_defaultlib.Parallel_FIR_filter_TB
