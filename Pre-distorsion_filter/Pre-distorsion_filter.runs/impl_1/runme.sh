...
HD_PWD='/home/miglioranza/Pre-distorsion_filter/Pre-distorsion_filter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Parallel_FIR_filter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Parallel_FIR_filter.tcl -notrace
