...
#
# Generated by Vivado on Wed Jul 16 14:15:45 CEST 2025
...
fi_opts="-fault_dbg -fault_top Symbol_mapper_tb -fault_overwrite -fault_file ./fault_list"

# run elaboration
$bin_path/xmelab $xmelab_opts $fi_opts $design_libs_elab xil_defaultlib.Symbol_mapper_tb
