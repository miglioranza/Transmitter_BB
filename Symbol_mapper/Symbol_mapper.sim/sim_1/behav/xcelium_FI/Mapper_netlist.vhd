...
-- Date        : Fri Sep  5 13:06:55 2025
-- Host        : uxsrv005 running 64-bit Red Hat Enterprise Linux release 8.10 (Ootpa)
-- Command     : write_vhdl -force
--               /ihp/departments/D-SYA/work/miglioranza/Symbol_mapper/Symbol_mapper.sim/sim_1/behav/xcelium_FI/Mapper_netlist.vhd
...
entity Symbol_mapper is
  ...
  attribute NotValidForBitStream of Symbol_mapper : entity is true;
end Symbol_mapper;

architecture STRUCTURE of Symbol_mapper is
  ...
  signal data_out_ready11_out : STD_LOGIC;
...
data_out_last_reg: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
