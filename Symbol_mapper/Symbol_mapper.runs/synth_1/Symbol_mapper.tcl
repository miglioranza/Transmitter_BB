...
namespace eval ::optrace {
  variable script "/ihp/departments/D-SYA/work/miglioranza/Symbol_mapper/Symbol_mapper.runs/synth_1/Symbol_mapper.tcl"
...
set_property webtalk.parent_dir /ihp/departments/D-SYA/work/miglioranza/Symbol_mapper/Symbol_mapper.cache/wt [current_project]
set_property parent.project_path /ihp/departments/D-SYA/work/miglioranza/Symbol_mapper/Symbol_mapper.xpr [current_project]
set_property default_lib xil_defaultlib [current_project]
set_property target_language Verilog [current_project]
set_property board_part xilinx.com:zcu111:part0:1.4 [current_project]
set_property ip_repo_paths /ihp/departments/D-SYA/work/miglioranza/Symbol_mapper/Symbol_mapper.srcs [current_project]
update_ip_catalog
set_property ip_output_repo /ihp/departments/D-SYA/work/miglioranza/Symbol_mapper/Symbol_mapper.cache/ip [current_project]
set_property ip_cache_permissions {read write} [current_project]
OPTRACE "Creating in-memory project" END { }
OPTRACE "Adding files" START { }
read_vhdl -library xil_defaultlib /ihp/departments/D-SYA/work/miglioranza/Symbol_mapper/Symbol_mapper.srcs/sources_1/new/Symbol_mapper.vhd
...
read_xdc /ihp/departments/D-SYA/work/miglioranza/Symbol_mapper/Symbol_mapper.srcs/constrs_1/new/Mapper_constraint.xdc
set_property used_in_implementation false [get_files /ihp/departments/D-SYA/work/miglioranza/Symbol_mapper/Symbol_mapper.srcs/constrs_1/new/Mapper_constraint.xdc]

set_param ips.enableIPCacheLiteLoad 1

read_checkpoint -auto_incremental -incremental /ihp/departments/D-SYA/work/miglioranza/Symbol_mapper/Symbol_mapper.srcs/utils_1/imports/synth_1/Symbol_mapper.dcp
close [open __synthesis_is_running__ w]

OPTRACE "synth_design" START { }
synth_design -top Symbol_mapper -part xczu28dr-ffvg1517-2-e
...
write_checkpoint -force -noxdef Symbol_mapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file Symbol_mapper_utilization_synth.rpt -pb Symbol_mapper_utilization_synth.pb"
