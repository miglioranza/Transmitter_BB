...
HD_PWD='/ihp/departments/D-SYA/work/miglioranza/Symbol_mapper/Symbol_mapper.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Symbol_mapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Symbol_mapper.tcl
