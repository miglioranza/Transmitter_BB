...
HD_PWD='/home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CU_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CU_top.tcl -notrace
