...
namespace eval ::optrace {
  variable script "/home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.runs/impl_1/CU_top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.runs/synth_1/CU_top.dcp
...
OPTRACE "read constraints: implementation" START { }
  read_xdc /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.srcs/constrs_1/new/CU_constraint.xdc
OPTRACE "read constraints: implementation" END { }
OPTRACE "add files" END { }
OPTRACE "link_design" START { }
  link_design -top CU_top -part xczu28dr-ffvg1517-2-e 
...
OPTRACE "Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force CU_top_opt.dcp
OPTRACE "Opt Design: write_checkpoint" END { }
OPTRACE "opt_design reports" START { REPORT }
  create_report "impl_1_opt_report_drc_0" "report_drc -file CU_top_drc_opted.rpt -pb CU_top_drc_opted.pb -rpx CU_top_drc_opted.rpx"
...
OPTRACE "Place Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force CU_top_placed.dcp
OPTRACE "Place Design: write_checkpoint" END { }
OPTRACE "place_design reports" START { REPORT }
  create_report "impl_1_place_report_io_0" "report_io -file CU_top_io_placed.rpt"
  create_report "impl_1_place_report_utilization_0" "report_utilization -file CU_top_utilization_placed.rpt -pb CU_top_utilization_placed.pb"
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file CU_top_control_sets_placed.rpt"
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force CU_top_physopt.dcp
...
OPTRACE "Route Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force CU_top_routed.dcp
OPTRACE "Route Design: write_checkpoint" END { }
OPTRACE "route_design reports" START { REPORT }
  create_report "impl_1_route_report_drc_0" "report_drc -file CU_top_drc_routed.rpt -pb CU_top_drc_routed.pb -rpx CU_top_drc_routed.rpx"
  create_report "impl_1_route_report_methodology_0" "report_methodology -file CU_top_methodology_drc_routed.rpt -pb CU_top_methodology_drc_routed.pb -rpx CU_top_methodology_drc_routed.rpx"
  create_report "impl_1_route_report_power_0" "report_power -file CU_top_power_routed.rpt -pb CU_top_power_summary_routed.pb -rpx CU_top_power_routed.rpx"
  create_report "impl_1_route_report_route_status_0" "report_route_status -file CU_top_route_status.rpt -pb CU_top_route_status.pb"
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -report_unconstrained -file CU_top_timing_summary_routed.rpt -pb CU_top_timing_summary_routed.pb -rpx CU_top_timing_summary_routed.rpx -warn_on_violation "
  create_report "impl_1_route_report_incremental_reuse_0" "report_incremental_reuse -file CU_top_incremental_reuse_routed.rpt"
  create_report "impl_1_route_report_clock_utilization_0" "report_clock_utilization -file CU_top_clock_utilization_routed.rpt"
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file CU_top_bus_skew_routed.rpt -pb CU_top_bus_skew_routed.pb -rpx CU_top_bus_skew_routed.rpx"
...
if {$rc} {
  write_checkpoint -force CU_top_routed_error.dcp
