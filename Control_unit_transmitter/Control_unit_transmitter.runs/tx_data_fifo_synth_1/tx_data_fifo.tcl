...
namespace eval ::optrace {
  variable script "/home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.runs/tx_data_fifo_synth_1/tx_data_fifo.tcl"
...
OPTRACE "tx_data_fifo_synth_1" START { ROLLUP_AUTO }
...
set_property webtalk.parent_dir /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.cache/wt [current_project]
set_property parent.project_path /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.xpr [current_project]
set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO} [current_project]
set_property default_lib xil_defaultlib [current_project]
set_property target_language VHDL [current_project]
set_property board_part xilinx.com:zcu111:part0:1.4 [current_project]
set_property ip_repo_paths /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.srcs [current_project]
update_ip_catalog
...
read_ip -quiet /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.srcs/sources_1/ip/tx_data_fifo/tx_data_fifo.xci
set_property used_in_implementation false [get_files -all /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.gen/sources_1/ip/tx_data_fifo/tx_data_fifo_ooc.xdc]
...
set cacheID [config_ip_cache -export -no_bom  -dir /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.runs/tx_data_fifo_synth_1 -new_name tx_data_fifo -ip [get_ips tx_data_fifo]]
...
synth_design -top tx_data_fifo -part xczu28dr-ffvg1517-2-e -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix tx_data_fifo_ tx_data_fifo.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ tx_data_fifo_stub.v
 lappend ipCachedFiles tx_data_fifo_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ tx_data_fifo_stub.vhdl
 lappend ipCachedFiles tx_data_fifo_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ tx_data_fifo_sim_netlist.v
 lappend ipCachedFiles tx_data_fifo_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ tx_data_fifo_sim_netlist.vhdl
 lappend ipCachedFiles tx_data_fifo_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp tx_data_fifo.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips tx_data_fifo]
 }
...
rename_ref -prefix_all tx_data_fifo_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef tx_data_fifo.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "tx_data_fifo_synth_1_synth_report_utilization_0" "report_utilization -file tx_data_fifo_utilization_synth.rpt -pb tx_data_fifo_utilization_synth.pb"
OPTRACE "synth reports" END { }

if { [catch {
  file copy -force /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.runs/tx_data_fifo_synth_1/tx_data_fifo.dcp /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.gen/sources_1/ip/tx_data_fifo/tx_data_fifo.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.gen/sources_1/ip/tx_data_fifo/tx_data_fifo_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.gen/sources_1/ip/tx_data_fifo/tx_data_fifo_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.gen/sources_1/ip/tx_data_fifo/tx_data_fifo_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.gen/sources_1/ip/tx_data_fifo/tx_data_fifo_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.runs/tx_data_fifo_synth_1/tx_data_fifo_stub.v /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.gen/sources_1/ip/tx_data_fifo/tx_data_fifo_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.runs/tx_data_fifo_synth_1/tx_data_fifo_stub.vhdl /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.gen/sources_1/ip/tx_data_fifo/tx_data_fifo_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.runs/tx_data_fifo_synth_1/tx_data_fifo_sim_netlist.v /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.gen/sources_1/ip/tx_data_fifo/tx_data_fifo_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.runs/tx_data_fifo_synth_1/tx_data_fifo_sim_netlist.vhdl /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.gen/sources_1/ip/tx_data_fifo/tx_data_fifo_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.ip_user_files/ip/tx_data_fifo]} {
  catch { 
    file copy -force /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.gen/sources_1/ip/tx_data_fifo/tx_data_fifo_stub.v /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.ip_user_files/ip/tx_data_fifo
  }
}

if {[file isdir /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.ip_user_files/ip/tx_data_fifo]} {
  catch { 
    file copy -force /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.gen/sources_1/ip/tx_data_fifo/tx_data_fifo_stub.vhdl /home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.ip_user_files/ip/tx_data_fifo
  }
}
file delete __synthesis_is_running__
close [open __synthesis_is_complete__ w]
OPTRACE "tx_data_fifo_synth_1" END { }
