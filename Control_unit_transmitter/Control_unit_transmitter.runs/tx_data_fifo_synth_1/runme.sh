...
HD_PWD='/home/miglioranza/Control_unit_transmitter/Control_unit_transmitter.runs/tx_data_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tx_data_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tx_data_fifo.tcl
