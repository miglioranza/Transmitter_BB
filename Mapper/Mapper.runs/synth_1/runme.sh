...
HD_PWD='/home/miglioranza/Mapper/Mapper.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mapper.tcl
