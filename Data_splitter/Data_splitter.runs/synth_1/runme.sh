...
HD_PWD='/home/miglioranza/Data_splitter/Data_splitter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Bit_splitter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Bit_splitter.tcl
