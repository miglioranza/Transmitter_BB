...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Bit_splitter is
  ...
  signal done_reg_i_11_n_0 : STD_LOGIC;
  signal done_reg_i_11_n_1 : STD_LOGIC;
  signal done_reg_i_11_n_2 : STD_LOGIC;
  signal done_reg_i_11_n_3 : STD_LOGIC;
  signal done_reg_i_11_n_4 : STD_LOGIC;
  signal done_reg_i_11_n_5 : STD_LOGIC;
  signal done_reg_i_11_n_6 : STD_LOGIC;
  signal done_reg_i_11_n_7 : STD_LOGIC;
  signal done_reg_i_20_n_0 : STD_LOGIC;
  signal done_reg_i_20_n_1 : STD_LOGIC;
  signal done_reg_i_20_n_2 : STD_LOGIC;
  signal done_reg_i_20_n_3 : STD_LOGIC;
  signal done_reg_i_20_n_4 : STD_LOGIC;
  signal done_reg_i_20_n_5 : STD_LOGIC;
  signal done_reg_i_20_n_6 : STD_LOGIC;
  signal done_reg_i_20_n_7 : STD_LOGIC;
  ...
  signal done_reg_i_9_n_1 : STD_LOGIC;
  signal done_reg_i_9_n_2 : STD_LOGIC;
  signal done_reg_i_9_n_3 : STD_LOGIC;
  signal done_reg_i_9_n_4 : STD_LOGIC;
  signal done_reg_i_9_n_5 : STD_LOGIC;
  signal done_reg_i_9_n_6 : STD_LOGIC;
  signal done_reg_i_9_n_7 : STD_LOGIC;
  ...
  signal NLW_done_reg_i_11_O_UNCONNECTED : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal NLW_done_reg_i_20_O_UNCONNECTED : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal NLW_done_reg_i_8_O_UNCONNECTED : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal NLW_done_reg_i_9_O_UNCONNECTED : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute SOFT_HLUTNM of \data_out[1]_i_5\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \data_out[2]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \data_out[2]_i_3\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \data_out[2]_i_5\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \data_out[3]_i_3\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \data_out[3]_i_5\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \data_out[4]_i_18\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \data_out[4]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \data_out[4]_i_7\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \data_out[5]_i_12\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \data_out[5]_i_3\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \data_out[5]_i_4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \data_out[5]_i_7\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \data_out[5]_i_9\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of data_out_ready_i_10 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of data_out_ready_i_19 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of data_out_ready_i_20 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of data_out_ready_i_3 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of data_out_ready_i_7 : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of data_out_valid_i_1 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of done_i_2 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of done_i_6 : label is "soft_lutpair8";
  attribute COMPARATOR_THRESHOLD of done_reg_i_11 : label is 11;
  attribute COMPARATOR_THRESHOLD of done_reg_i_20 : label is 11;
  attribute COMPARATOR_THRESHOLD of done_reg_i_8 : label is 11;
  attribute COMPARATOR_THRESHOLD of done_reg_i_9 : label is 11;
...
\data_out[5]_i_9\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
data_out_ready_i_12: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => data_out_ready_i_23_n_0,
      I2 => i_reg(2),
      I3 => data_out_ready_i_24_n_0,
      I4 => data_out_ready_i_25_n_0,
...
data_out_ready_i_17: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
        ...
        port map (
      I0 => data_out_ready_i_29_n_0,
      I1 => data_out_ready_i_22_n_0,
      I2 => i_reg(4),
      I3 => i_reg(5),
...
data_out_ready_i_18: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => i_reg(22),
      I3 => i_reg(23),
      I4 => data_out_ready_i_31_n_0,
      I5 => data_out_ready_i_28_n_0,
      O => data_out_ready_i_18_n_0
    );
data_out_ready_i_19: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF7F"
    )
        port map (
...
data_out_ready_i_20: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FBFF"
    )
        port map (
...
data_out_ready_i_22: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
data_out_ready_i_25: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
data_out_ready_i_26: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFEEFE"
    )
        port map (
      ...
      I2 => i_reg(15),
      I3 => i_reg(16),
      I4 => data_out_ready_i_33_n_0,
      O => data_out_ready_i_26_n_0
    );
data_out_ready_i_27: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFF2F2FFF2"
    )
        port map (
...
data_out_ready_i_28: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFF2F2FFF2"
    )
        port map (
...
data_out_ready_i_29: unisim.vcomponents.LUT3
    generic map(
      INIT => X"BA"
    )
        port map (
...
data_out_ready_i_31: unisim.vcomponents.LUT3
    generic map(
      INIT => X"BA"
    )
        port map (
...
data_out_ready_i_32: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\data_out_reg[5]_i_13\: unisim.vcomponents.CARRY8
     port map (
      ...
      DI(0) => \data_out[5]_i_22_n_0\,
      O(7 downto 0) => \NLW_data_out_reg[5]_i_13_O_UNCONNECTED\(7 downto 0),
      S(7) => \data_out[5]_i_23_n_0\,
      S(6) => \data_out[5]_i_24_n_0\,
      S(5) => \data_out[5]_i_25_n_0\,
      S(4) => \data_out[5]_i_26_n_0\,
      S(3) => \data_out[5]_i_27_n_0\,
      S(2) => \data_out[5]_i_28_n_0\,
      S(1) => \data_out[5]_i_29_n_0\,
      S(0) => \data_out[5]_i_30_n_0\
    );
...
done_i_35: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
done_i_37: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
done_i_38: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
done_reg_i_11: unisim.vcomponents.CARRY8
     port map (
      CI => '0',
      CI_TOP => '0',
      CO(7) => done_reg_i_11_n_0,
      CO(6) => done_reg_i_11_n_1,
      CO(5) => done_reg_i_11_n_2,
      CO(4) => done_reg_i_11_n_3,
      CO(3) => done_reg_i_11_n_4,
      CO(2) => done_reg_i_11_n_5,
      CO(1) => done_reg_i_11_n_6,
      CO(0) => done_reg_i_11_n_7,
      DI(7 downto 2) => B"000000",
      DI(1) => done_i_29_n_0,
      DI(0) => done_i_30_n_0,
      O(7 downto 0) => NLW_done_reg_i_11_O_UNCONNECTED(7 downto 0),
      S(7) => done_i_31_n_0,
      S(6) => done_i_32_n_0,
      S(5) => done_i_33_n_0,
      S(4) => done_i_34_n_0,
...
done_reg_i_20: unisim.vcomponents.CARRY8
     port map (
      CI => '0',
      CI_TOP => '0',
      CO(7) => done_reg_i_20_n_0,
      CO(6) => done_reg_i_20_n_1,
      CO(5) => done_reg_i_20_n_2,
      CO(4) => done_reg_i_20_n_3,
      CO(3) => done_reg_i_20_n_4,
      CO(2) => done_reg_i_20_n_5,
      CO(1) => done_reg_i_20_n_6,
      CO(0) => done_reg_i_20_n_7,
      DI(7 downto 2) => B"000000",
      DI(1) => done_i_39_n_0,
      DI(0) => done_i_40_n_0,
      O(7 downto 0) => NLW_done_reg_i_20_O_UNCONNECTED(7 downto 0),
      S(7) => done_i_41_n_0,
      S(6) => done_i_42_n_0,
      S(5) => done_i_43_n_0,
      S(4) => done_i_44_n_0,
...
done_reg_i_9: unisim.vcomponents.CARRY8
     port map (
      CI => done_reg_i_20_n_0,
      CI_TOP => '0',
      CO(7) => done_reg_i_9_n_0,
      CO(6) => done_reg_i_9_n_1,
      CO(5) => done_reg_i_9_n_2,
      CO(4) => done_reg_i_9_n_3,
      CO(3) => done_reg_i_9_n_4,
      CO(2) => done_reg_i_9_n_5,
      CO(1) => done_reg_i_9_n_6,
      CO(0) => done_reg_i_9_n_7,
      DI(7) => i_reg(31),
      DI(6 downto 0) => B"0000000",
      O(7 downto 0) => NLW_done_reg_i_9_O_UNCONNECTED(7 downto 0),
      S(7) => done_i_21_n_0,
      S(6) => done_i_22_n_0,
      S(5) => done_i_23_n_0,
      S(4) => done_i_24_n_0,
