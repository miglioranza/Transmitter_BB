...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Bit_splitter is
  ...
  signal data_out_ready019_out : STD_LOGIC;
  ...
  signal data_out_ready_reg_i_22_n_0 : STD_LOGIC;
  signal data_out_ready_reg_i_22_n_1 : STD_LOGIC;
  signal data_out_ready_reg_i_22_n_2 : STD_LOGIC;
  signal data_out_ready_reg_i_22_n_3 : STD_LOGIC;
  signal data_out_ready_reg_i_22_n_4 : STD_LOGIC;
  signal data_out_ready_reg_i_22_n_5 : STD_LOGIC;
  signal data_out_ready_reg_i_22_n_6 : STD_LOGIC;
  signal data_out_ready_reg_i_22_n_7 : STD_LOGIC;
  signal \data_out_reg[5]_i_11_n_0\ : STD_LOGIC;
  signal \data_out_reg[5]_i_11_n_1\ : STD_LOGIC;
  signal \data_out_reg[5]_i_11_n_2\ : STD_LOGIC;
  signal \data_out_reg[5]_i_11_n_3\ : STD_LOGIC;
  signal \data_out_reg[5]_i_11_n_4\ : STD_LOGIC;
  signal \data_out_reg[5]_i_11_n_5\ : STD_LOGIC;
  signal \data_out_reg[5]_i_11_n_6\ : STD_LOGIC;
  signal \data_out_reg[5]_i_11_n_7\ : STD_LOGIC;
  signal \data_out_reg[5]_i_16_n_0\ : STD_LOGIC;
  signal \data_out_reg[5]_i_16_n_1\ : STD_LOGIC;
  signal \data_out_reg[5]_i_16_n_2\ : STD_LOGIC;
  signal \data_out_reg[5]_i_16_n_3\ : STD_LOGIC;
  signal \data_out_reg[5]_i_16_n_4\ : STD_LOGIC;
  signal \data_out_reg[5]_i_16_n_5\ : STD_LOGIC;
  signal \data_out_reg[5]_i_16_n_6\ : STD_LOGIC;
  signal \data_out_reg[5]_i_16_n_7\ : STD_LOGIC;
  ...
  signal NLW_data_out_ready_reg_i_22_O_UNCONNECTED : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal \NLW_data_out_reg[5]_i_11_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal \NLW_data_out_reg[5]_i_16_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute SOFT_HLUTNM of \data_out[1]_i_7\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \data_out[2]_i_10\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \data_out[2]_i_6\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \data_out[3]_i_10\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \data_out[3]_i_6\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \data_out[4]_i_11\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \data_out[4]_i_17\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \data_out[4]_i_19\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \data_out[4]_i_21\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \data_out[4]_i_23\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \data_out[4]_i_4\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \data_out[4]_i_6\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \data_out[4]_i_7\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \data_out[4]_i_8\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \data_out[5]_i_13\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \data_out[5]_i_15\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \data_out[5]_i_24\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \data_out[5]_i_4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \data_out[5]_i_9\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of data_out_ready_i_11 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of data_out_ready_i_12 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of data_out_ready_i_13 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of data_out_ready_i_16 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of data_out_ready_i_17 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of data_out_ready_i_18 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of data_out_ready_i_8 : label is "soft_lutpair3";
  attribute COMPARATOR_THRESHOLD of data_out_ready_reg_i_15 : label is 11;
  attribute COMPARATOR_THRESHOLD of data_out_ready_reg_i_22 : label is 11;
  attribute COMPARATOR_THRESHOLD of \data_out_reg[5]_i_11\ : label is 11;
  attribute COMPARATOR_THRESHOLD of \data_out_reg[5]_i_16\ : label is 11;
  ...
  attribute SOFT_HLUTNM of done_i_3 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of done_i_4 : label is "soft_lutpair6";
...
\data_out[5]_i_15\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\data_out[5]_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FE0E"
    )
        port map (
...
data_out_ready_i_12: unisim.vcomponents.LUT3
    generic map(
      INIT => X"02"
    )
        port map (
...
data_out_ready_i_13: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F4"
    )
        port map (
...
data_out_ready_reg_i_15: unisim.vcomponents.CARRY8
     port map (
      ...
      S(7) => data_out_ready_i_23_n_0,
      S(6) => data_out_ready_i_24_n_0,
      S(5) => data_out_ready_i_25_n_0,
      S(4) => data_out_ready_i_26_n_0,
      S(3) => data_out_ready_i_27_n_0,
      S(2) => data_out_ready_i_28_n_0,
      S(1) => data_out_ready_i_29_n_0,
      S(0) => data_out_ready_i_30_n_0
    );
data_out_ready_reg_i_22: unisim.vcomponents.CARRY8
     port map (
      CI => '0',
      CI_TOP => '0',
      CO(7) => data_out_ready_reg_i_22_n_0,
      CO(6) => data_out_ready_reg_i_22_n_1,
      CO(5) => data_out_ready_reg_i_22_n_2,
      CO(4) => data_out_ready_reg_i_22_n_3,
      CO(3) => data_out_ready_reg_i_22_n_4,
      CO(2) => data_out_ready_reg_i_22_n_5,
      CO(1) => data_out_ready_reg_i_22_n_6,
      CO(0) => data_out_ready_reg_i_22_n_7,
      DI(7 downto 2) => B"000000",
      DI(1) => data_out_ready_i_34_n_0,
      DI(0) => data_out_ready_i_35_n_0,
      O(7 downto 0) => NLW_data_out_ready_reg_i_22_O_UNCONNECTED(7 downto 0),
...
\data_out_reg[5]_i_11\: unisim.vcomponents.CARRY8
     port map (
      CI => \data_out_reg[5]_i_25_n_0\,
      CI_TOP => '0',
      CO(7) => \data_out_reg[5]_i_11_n_0\,
      CO(6) => \data_out_reg[5]_i_11_n_1\,
      CO(5) => \data_out_reg[5]_i_11_n_2\,
      CO(4) => \data_out_reg[5]_i_11_n_3\,
      CO(3) => \data_out_reg[5]_i_11_n_4\,
      CO(2) => \data_out_reg[5]_i_11_n_5\,
      CO(1) => \data_out_reg[5]_i_11_n_6\,
      CO(0) => \data_out_reg[5]_i_11_n_7\,
      DI(7) => i_reg(31),
      DI(6 downto 0) => B"0000000",
      O(7 downto 0) => \NLW_data_out_reg[5]_i_11_O_UNCONNECTED\(7 downto 0),
      S(7) => \data_out[5]_i_26_n_0\,
      S(6) => \data_out[5]_i_27_n_0\,
      S(5) => \data_out[5]_i_28_n_0\,
      S(4) => \data_out[5]_i_29_n_0\,
      S(3) => \data_out[5]_i_30_n_0\,
      S(2) => \data_out[5]_i_31_n_0\,
      S(1) => \data_out[5]_i_32_n_0\,
      S(0) => \data_out[5]_i_33_n_0\
    );
\data_out_reg[5]_i_16\: unisim.vcomponents.CARRY8
     port map (
      CI => \data_out[5]_i_34_n_0\,
      CI_TOP => '0',
      CO(7) => \data_out_reg[5]_i_16_n_0\,
      CO(6) => \data_out_reg[5]_i_16_n_1\,
      CO(5) => \data_out_reg[5]_i_16_n_2\,
      CO(4) => \data_out_reg[5]_i_16_n_3\,
      CO(3) => \data_out_reg[5]_i_16_n_4\,
      CO(2) => \data_out_reg[5]_i_16_n_5\,
      CO(1) => \data_out_reg[5]_i_16_n_6\,
      CO(0) => \data_out_reg[5]_i_16_n_7\,
      DI(7 downto 1) => B"0000000",
      DI(0) => \data_out[5]_i_35_n_0\,
      O(7 downto 0) => \NLW_data_out_reg[5]_i_16_O_UNCONNECTED\(7 downto 0),
...
\data_out_reg[5]_i_7\: unisim.vcomponents.CARRY8
     port map (
      ...
      S(7) => '0',
      S(6) => \data_out[5]_i_17_n_0\,
      S(5) => \data_out[5]_i_18_n_0\,
      S(4) => \data_out[5]_i_19_n_0\,
      S(3) => \data_out[5]_i_20_n_0\,
      S(2) => \data_out[5]_i_21_n_0\,
