...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Bit_splitter is
  ...
  signal data_out_ready_i_58_n_0 : STD_LOGIC;
  signal data_out_ready_i_59_n_0 : STD_LOGIC;
  signal data_out_ready_i_5_n_0 : STD_LOGIC;
  signal data_out_ready_i_60_n_0 : STD_LOGIC;
  signal data_out_ready_i_61_n_0 : STD_LOGIC;
  signal data_out_ready_i_62_n_0 : STD_LOGIC;
  signal data_out_ready_i_63_n_0 : STD_LOGIC;
  signal data_out_ready_i_64_n_0 : STD_LOGIC;
  signal data_out_ready_i_65_n_0 : STD_LOGIC;
  signal data_out_ready_i_66_n_0 : STD_LOGIC;
  signal data_out_ready_i_67_n_0 : STD_LOGIC;
  ...
  signal data_out_ready_reg_i_16_n_0 : STD_LOGIC;
  signal data_out_ready_reg_i_16_n_1 : STD_LOGIC;
  signal data_out_ready_reg_i_16_n_2 : STD_LOGIC;
  signal data_out_ready_reg_i_16_n_3 : STD_LOGIC;
  signal data_out_ready_reg_i_16_n_4 : STD_LOGIC;
  signal data_out_ready_reg_i_16_n_5 : STD_LOGIC;
  signal data_out_ready_reg_i_16_n_6 : STD_LOGIC;
  signal data_out_ready_reg_i_16_n_7 : STD_LOGIC;
  signal data_out_ready_reg_i_24_n_0 : STD_LOGIC;
  signal data_out_ready_reg_i_24_n_1 : STD_LOGIC;
  signal data_out_ready_reg_i_24_n_2 : STD_LOGIC;
  signal data_out_ready_reg_i_24_n_3 : STD_LOGIC;
  signal data_out_ready_reg_i_24_n_4 : STD_LOGIC;
  signal data_out_ready_reg_i_24_n_5 : STD_LOGIC;
  signal data_out_ready_reg_i_24_n_6 : STD_LOGIC;
  signal data_out_ready_reg_i_24_n_7 : STD_LOGIC;
  signal data_out_ready_reg_i_34_n_0 : STD_LOGIC;
  signal data_out_ready_reg_i_34_n_1 : STD_LOGIC;
  signal data_out_ready_reg_i_34_n_2 : STD_LOGIC;
  signal data_out_ready_reg_i_34_n_3 : STD_LOGIC;
  signal data_out_ready_reg_i_34_n_4 : STD_LOGIC;
  signal data_out_ready_reg_i_34_n_5 : STD_LOGIC;
  signal data_out_ready_reg_i_34_n_6 : STD_LOGIC;
  signal data_out_ready_reg_i_34_n_7 : STD_LOGIC;
  ...
  signal NLW_data_out_ready_reg_i_10_O_UNCONNECTED : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal NLW_data_out_ready_reg_i_16_O_UNCONNECTED : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal NLW_data_out_ready_reg_i_24_O_UNCONNECTED : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal NLW_data_out_ready_reg_i_34_O_UNCONNECTED : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal \NLW_data_out_reg[5]_i_4_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 to 7 );
  ...
  attribute SOFT_HLUTNM of \data_out[1]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \data_out[1]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \data_out[2]_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \data_out[3]_i_10\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \data_out[3]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \data_out[3]_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \data_out[4]_i_19\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \data_out[5]_i_17\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \data_out[5]_i_6\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of data_out_ready_i_12 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of data_out_ready_i_17 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of data_out_ready_i_43 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of data_out_ready_i_44 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of data_out_ready_i_5 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of data_out_ready_i_8 : label is "soft_lutpair7";
  attribute COMPARATOR_THRESHOLD of data_out_ready_reg_i_10 : label is 11;
  attribute COMPARATOR_THRESHOLD of data_out_ready_reg_i_16 : label is 11;
  attribute COMPARATOR_THRESHOLD of data_out_ready_reg_i_24 : label is 11;
  attribute COMPARATOR_THRESHOLD of data_out_ready_reg_i_34 : label is 11;
  ...
  attribute SOFT_HLUTNM of done_i_10 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of done_i_9 : label is "soft_lutpair9";
...
\data_out[0]_i_5\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => i_reg(4),
      I2 => \data_out_reg[0]_i_12_n_0\,
      I3 => mod_type(0),
      I4 => \data_out_reg[0]_i_13_n_0\,
      I5 => mod_type(1),
...
data_out_ready_i_15: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFF2"
    )
        port map (
...
data_out_ready_i_17: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
        ...
        port map (
      I0 => data_out_ready_i_15_n_0,
      I1 => data_out_ready_i_21_n_0,
      O => data_out_ready_i_17_n_0
    );
data_out_ready_i_18: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => i_reg(26),
      I4 => i_reg(3),
      I5 => data_out_ready_i_43_n_0,
      O => data_out_ready_i_18_n_0
    );
data_out_ready_i_19: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFEFFFFFFFFF"
    )
        port map (
      I0 => data_out_ready_i_11_n_0,
      I1 => data_out_ready_i_44_n_0,
      I2 => i_reg(3),
      I3 => i_reg(24),
      I4 => i_reg(5),
      I5 => i_reg(4),
...
data_out_ready_i_21: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => i_reg(31),
      I2 => i_reg(25),
      I3 => data_out_ready_i_45_n_0,
      I4 => i_reg(28),
      I5 => i_reg(29),
      O => data_out_ready_i_21_n_0
    );
data_out_ready_i_22: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => i_reg(7),
      I3 => i_reg(6),
      I4 => data_out_ready_i_46_n_0,
      I5 => data_out_ready_i_47_n_0,
      O => data_out_ready_i_22_n_0
    );
data_out_ready_i_23: unisim.vcomponents.LUT6
    generic map(
      INIT => X"33337377FF3F7377"
    )
        port map (
      I0 => \data_out1__15_carry__0_n_0\,
      I1 => mod_type(2),
...
data_out_ready_i_3: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \data_out1__15_carry__0_n_0\,
      I2 => mod_type(2),
      I3 => data_out_ready_reg_i_10_n_0,
      I4 => mod_type(1),
...
data_out_ready_i_43: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
data_out_ready_i_46: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFF2F2FFF2"
    )
        port map (
...
data_out_ready_i_47: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFEFF"
    )
        port map (
...
data_out_ready_i_5: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => mod_type(1),
      I1 => data_out_ready_reg_i_10_n_0,
...
data_out_ready_i_58: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
      I0 => i_reg(2),
      I1 => i_reg(3),
      O => data_out_ready_i_58_n_0
    );
data_out_ready_i_59: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
data_out_ready_i_6: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AABAAABAAABAAAAA"
        ...
        port map (
      I0 => mod_type(2),
      I1 => data_out_ready_reg_i_16_n_0,
      I2 => mod_type(0),
      I3 => mod_type(1),
      I4 => data_out_ready_i_17_n_0,
      I5 => data_out_ready_i_18_n_0,
      O => data_out_ready_i_6_n_0
    );
data_out_ready_i_60: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => i_reg(15),
      I1 => i_reg(14),
      O => data_out_ready_i_60_n_0
    );
data_out_ready_i_61: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => i_reg(13),
      I1 => i_reg(12),
      O => data_out_ready_i_61_n_0
    );
data_out_ready_i_62: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => i_reg(11),
      I1 => i_reg(10),
      O => data_out_ready_i_62_n_0
    );
data_out_ready_i_63: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => i_reg(9),
      I1 => i_reg(8),
      O => data_out_ready_i_63_n_0
    );
data_out_ready_i_64: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => i_reg(7),
      I1 => i_reg(6),
      O => data_out_ready_i_64_n_0
    );
data_out_ready_i_65: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => i_reg(5),
      I1 => i_reg(4),
      O => data_out_ready_i_65_n_0
    );
data_out_ready_i_66: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => i_reg(3),
      I1 => i_reg(2),
      O => data_out_ready_i_66_n_0
    );
data_out_ready_i_67: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
data_out_ready_i_7: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => mod_type(0),
      I2 => data_out_ready_i_17_n_0,
      I3 => data_out_ready_i_19_n_0,
      I4 => data_out_ready_i_20_n_0,
      I5 => data_out_ready_i_12_n_0,
...
data_out_ready_i_8: unisim.vcomponents.LUT4
    generic map(
      ...
      I0 => mod_type(1),
      I1 => mod_type(0),
      I2 => data_out_ready_reg_i_16_n_0,
...
data_out_ready_i_9: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000000000001FFFF"
        ...
        port map (
      I0 => data_out_ready_i_12_n_0,
      I1 => data_out_ready_i_13_n_0,
      I2 => data_out_ready_i_21_n_0,
      I3 => data_out_ready_i_22_n_0,
      I4 => \data_out[1]_i_3_n_0\,
      I5 => data_out_ready_i_23_n_0,
...
data_out_ready_reg_i_10: unisim.vcomponents.CARRY8
     port map (
      CI => data_out_ready_reg_i_24_n_0,
      CI_TOP => '0',
      ...
      DI(7) => i_reg(31),
      DI(6 downto 0) => B"0000000",
      O(7 downto 0) => NLW_data_out_ready_reg_i_10_O_UNCONNECTED(7 downto 0),
      S(7) => data_out_ready_i_25_n_0,
      S(6) => data_out_ready_i_26_n_0,
      S(5) => data_out_ready_i_27_n_0,
      S(4) => data_out_ready_i_28_n_0,
      S(3) => data_out_ready_i_29_n_0,
      S(2) => data_out_ready_i_30_n_0,
      S(1) => data_out_ready_i_31_n_0,
      S(0) => data_out_ready_i_32_n_0
    );
data_out_ready_reg_i_16: unisim.vcomponents.CARRY8
     port map (
      CI => data_out_ready_reg_i_34_n_0,
      CI_TOP => '0',
      CO(7) => data_out_ready_reg_i_16_n_0,
      CO(6) => data_out_ready_reg_i_16_n_1,
      CO(5) => data_out_ready_reg_i_16_n_2,
      CO(4) => data_out_ready_reg_i_16_n_3,
      CO(3) => data_out_ready_reg_i_16_n_4,
      CO(2) => data_out_ready_reg_i_16_n_5,
      CO(1) => data_out_ready_reg_i_16_n_6,
      CO(0) => data_out_ready_reg_i_16_n_7,
      DI(7) => i_reg(31),
      DI(6 downto 0) => B"0000000",
      O(7 downto 0) => NLW_data_out_ready_reg_i_16_O_UNCONNECTED(7 downto 0),
      S(7) => data_out_ready_i_35_n_0,
      S(6) => data_out_ready_i_36_n_0,
      S(5) => data_out_ready_i_37_n_0,
      S(4) => data_out_ready_i_38_n_0,
      S(3) => data_out_ready_i_39_n_0,
      S(2) => data_out_ready_i_40_n_0,
      S(1) => data_out_ready_i_41_n_0,
      S(0) => data_out_ready_i_42_n_0
    );
data_out_ready_reg_i_24: unisim.vcomponents.CARRY8
     port map (
      CI => '0',
      CI_TOP => '0',
      CO(7) => data_out_ready_reg_i_24_n_0,
      CO(6) => data_out_ready_reg_i_24_n_1,
      CO(5) => data_out_ready_reg_i_24_n_2,
      CO(4) => data_out_ready_reg_i_24_n_3,
      CO(3) => data_out_ready_reg_i_24_n_4,
      CO(2) => data_out_ready_reg_i_24_n_5,
      CO(1) => data_out_ready_reg_i_24_n_6,
      CO(0) => data_out_ready_reg_i_24_n_7,
      DI(7 downto 2) => B"000000",
      DI(1) => data_out_ready_i_48_n_0,
      DI(0) => data_out_ready_i_49_n_0,
      O(7 downto 0) => NLW_data_out_ready_reg_i_24_O_UNCONNECTED(7 downto 0),
...
data_out_ready_reg_i_34: unisim.vcomponents.CARRY8
     port map (
      CI => '0',
      CI_TOP => '0',
      CO(7) => data_out_ready_reg_i_34_n_0,
      CO(6) => data_out_ready_reg_i_34_n_1,
      CO(5) => data_out_ready_reg_i_34_n_2,
      CO(4) => data_out_ready_reg_i_34_n_3,
      CO(3) => data_out_ready_reg_i_34_n_4,
      CO(2) => data_out_ready_reg_i_34_n_5,
      CO(1) => data_out_ready_reg_i_34_n_6,
      CO(0) => data_out_ready_reg_i_34_n_7,
      DI(7 downto 2) => B"000000",
      DI(1) => data_out_ready_i_58_n_0,
      DI(0) => data_out_ready_i_59_n_0,
      O(7 downto 0) => NLW_data_out_ready_reg_i_34_O_UNCONNECTED(7 downto 0),
      S(7) => data_out_ready_i_60_n_0,
      S(6) => data_out_ready_i_61_n_0,
      S(5) => data_out_ready_i_62_n_0,
      S(4) => data_out_ready_i_63_n_0,
      S(3) => data_out_ready_i_64_n_0,
      S(2) => data_out_ready_i_65_n_0,
      S(1) => data_out_ready_i_66_n_0,
      S(0) => data_out_ready_i_67_n_0
    );
...
\data_out_reg[0]_i_21\: unisim.vcomponents.MUXF7
     port map (
...
\data_out_reg[5]_i_4\: unisim.vcomponents.CARRY8
     port map (
      CI => \data_out_reg[5]_i_8_n_0\,
      CI_TOP => '0',
      CO(7) => \NLW_data_out_reg[5]_i_4_CO_UNCONNECTED\(7),
      ...
      S(7) => '0',
      S(6) => \data_out[5]_i_9_n_0\,
      S(5) => \data_out[5]_i_10_n_0\,
      S(4) => \data_out[5]_i_11_n_0\,
      S(3) => \data_out[5]_i_12_n_0\,
      S(2) => \data_out[5]_i_13_n_0\,
      S(1) => \data_out[5]_i_14_n_0\,
      S(0) => \data_out[5]_i_15_n_0\
    );
\data_out_reg[5]_i_8\: unisim.vcomponents.CARRY8
     port map (
      CI => \data_out[5]_i_18_n_0\,
      CI_TOP => '0',
      CO(7) => \data_out_reg[5]_i_8_n_0\,
      ...
      DI(0) => \data_out[5]_i_19_n_0\,
      O(7 downto 0) => \NLW_data_out_reg[5]_i_8_O_UNCONNECTED\(7 downto 0),
      S(7) => \data_out[5]_i_20_n_0\,
      S(6) => \data_out[5]_i_21_n_0\,
      S(5) => \data_out[5]_i_22_n_0\,
      S(4) => \data_out[5]_i_23_n_0\,
      S(3) => \data_out[5]_i_24_n_0\,
      S(2) => \data_out[5]_i_25_n_0\,
      S(1) => \data_out[5]_i_26_n_0\,
      S(0) => \data_out[5]_i_27_n_0\
    );
...
done_i_5: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AABAABBBAAAAAAAA"
    )
        port map (
      I0 => mod_type(2),
      I1 => mod_type(1),
      I2 => mod_type(0),
      I3 => data_out_ready_reg_i_16_n_0,
...
done_i_6: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFBFCFB"
    )
        port map (
      I0 => data_out_ready_reg_i_16_n_0,
      I1 => mod_type(0),
      I2 => i_reg(5),
      I3 => i_reg(4),
      I4 => \data_out1_carry__0_n_0\,
...
\i[0]_i_8\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"2222AAA2"
    )
        port map (
...
\i[16]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"2222AAA2"
    )
        port map (
...
\i[16]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"2222AAA2"
    )
        port map (
...
\i[24]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"2222AAA2"
    )
        port map (
...
\i[24]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"2222AAA2"
    )
        port map (
...
\i[24]_i_8\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"2222AAA2"
    )
        port map (
...
\i[24]_i_9\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"2222AAA2"
    )
        port map (
...
\i[8]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"2222AAA2"
    )
        port map (
...
\i[8]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"2222AAA2"
    )
        port map (
...
\i[8]_i_8\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"2222AAA2"
    )
        port map (
...
\i[8]_i_9\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"2222AAA2"
    )
        port map (
