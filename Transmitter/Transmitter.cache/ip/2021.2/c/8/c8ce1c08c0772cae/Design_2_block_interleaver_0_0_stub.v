...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, rst, data_in, data_in_ready, write_en, 
  code_rate, data_out, data_out_ready, read_valid)
/* synthesis syn_black_box black_box_pad_pin="clk,rst,data_in[31:0],data_in_ready,write_en,code_rate[1:0],data_out[31:0],data_out_ready,read_valid" */;
  input clk;
  input rst;
  input [31:0]data_in;
  input data_in_ready;
