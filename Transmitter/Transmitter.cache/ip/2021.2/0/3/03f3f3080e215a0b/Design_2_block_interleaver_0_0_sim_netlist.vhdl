...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_block_interleaver is
  ...
  signal \data_out_ready1_inferred__0/i__carry__0_n_6\ : STD_LOGIC;
  signal \data_out_ready1_inferred__0/i__carry__0_n_7\ : STD_LOGIC;
  signal \data_out_ready1_inferred__0/i__carry_n_0\ : STD_LOGIC;
  signal \data_out_ready1_inferred__0/i__carry_n_1\ : STD_LOGIC;
  signal \data_out_ready1_inferred__0/i__carry_n_2\ : STD_LOGIC;
  signal \data_out_ready1_inferred__0/i__carry_n_3\ : STD_LOGIC;
  signal \data_out_ready1_inferred__0/i__carry_n_4\ : STD_LOGIC;
  signal \data_out_ready1_inferred__0/i__carry_n_5\ : STD_LOGIC;
  signal \data_out_ready1_inferred__0/i__carry_n_6\ : STD_LOGIC;
  signal \data_out_ready1_inferred__0/i__carry_n_7\ : STD_LOGIC;
  ...
  signal \write_addr[10]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \NLW_data_out_ready1_inferred__0/i__carry_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal \NLW_data_out_ready1_inferred__0/i__carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 3 );
  signal \NLW_data_out_ready1_inferred__0/i__carry__0_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute SOFT_HLUTNM of \data_out_ready2__0_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \data_out_ready2__0_i_2\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \read_addr[3]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \read_addr[3]_i_3\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \write_addr[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \write_addr[11]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \write_addr[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \write_addr[9]_i_2\ : label is "soft_lutpair1";
begin
  data_out_ready <= \^data_out_ready\;
  read_valid <= \^read_valid\;
\FSM_onehot_state[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFF22222222222"
    )
        port map (
      I0 => \col_cnt[3]_i_1_n_0\,
...
\data_out_ready0_carry__0_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
        ...
        port map (
      I0 => data_out_ready10_in(28),
      I1 => data_out_ready10_in(27),
      I2 => data_out_ready10_in(29),
...
\data_out_ready0_carry__0_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
        ...
        port map (
      I0 => data_out_ready10_in(25),
      I1 => data_out_ready10_in(24),
      I2 => data_out_ready10_in(26),
...
data_out_ready0_carry_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
        ...
        port map (
      I0 => data_out_ready10_in(22),
      I1 => data_out_ready10_in(21),
      I2 => data_out_ready10_in(23),
...
data_out_ready0_carry_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
        ...
        port map (
      I0 => data_out_ready10_in(19),
      I1 => data_out_ready10_in(18),
      I2 => data_out_ready10_in(20),
...
data_out_ready0_carry_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
        ...
        port map (
      I0 => data_out_ready10_in(16),
      I1 => data_out_ready10_in(15),
      I2 => data_out_ready10_in(17),
...
data_out_ready0_carry_i_4: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
        ...
        port map (
      I0 => data_out_ready10_in(13),
      I1 => data_out_ready10_in(12),
      I2 => data_out_ready10_in(14),
...
data_out_ready0_carry_i_5: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
        ...
        port map (
      I0 => data_out_ready10_in(11),
      I1 => write_addr(11),
      I2 => write_addr(9),
      I3 => data_out_ready10_in(9),
      I4 => write_addr(10),
      I5 => data_out_ready10_in(10),
...
data_out_ready0_carry_i_6: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
        ...
        port map (
      I0 => data_out_ready10_in(8),
      I1 => write_addr(8),
      I2 => write_addr(6),
      I3 => data_out_ready10_in(6),
      I4 => write_addr(7),
      I5 => data_out_ready10_in(7),
...
data_out_ready0_carry_i_7: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
        ...
        port map (
      I0 => data_out_ready10_in(5),
      I1 => write_addr(5),
      I2 => write_addr(3),
      I3 => data_out_ready10_in(3),
      I4 => write_addr(4),
      I5 => data_out_ready10_in(4),
...
data_out_ready0_carry_i_8: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
        ...
        port map (
      I0 => data_out_ready10_in(2),
      I1 => write_addr(2),
      I2 => write_addr(0),
      I3 => data_out_ready10_in(0),
      I4 => write_addr(1),
      I5 => data_out_ready10_in(1),
...
\data_out_ready1_inferred__0/i__carry\: unisim.vcomponents.CARRY8
     port map (
      CI => '1',
      CI_TOP => '0',
      CO(7) => \data_out_ready1_inferred__0/i__carry_n_0\,
      CO(6) => \data_out_ready1_inferred__0/i__carry_n_1\,
      CO(5) => \data_out_ready1_inferred__0/i__carry_n_2\,
      CO(4) => \data_out_ready1_inferred__0/i__carry_n_3\,
      CO(3) => \data_out_ready1_inferred__0/i__carry_n_4\,
      CO(2) => \data_out_ready1_inferred__0/i__carry_n_5\,
      CO(1) => \data_out_ready1_inferred__0/i__carry_n_6\,
      CO(0) => \data_out_ready1_inferred__0/i__carry_n_7\,
      DI(7 downto 0) => B"00000000",
      O(7 downto 0) => \NLW_data_out_ready1_inferred__0/i__carry_O_UNCONNECTED\(7 downto 0),
...
\data_out_ready1_inferred__0/i__carry__0\: unisim.vcomponents.CARRY8
     port map (
      CI => \data_out_ready1_inferred__0/i__carry_n_0\,
      CI_TOP => '0',
      CO(7 downto 3) => \NLW_data_out_ready1_inferred__0/i__carry__0_CO_UNCONNECTED\(7 downto 3),
      CO(2) => data_out_ready1,
      CO(1) => \data_out_ready1_inferred__0/i__carry__0_n_6\,
      CO(0) => \data_out_ready1_inferred__0/i__carry__0_n_7\,
      DI(7 downto 0) => B"00000000",
      O(7 downto 0) => \NLW_data_out_ready1_inferred__0/i__carry__0_O_UNCONNECTED\(7 downto 0),
      S(7 downto 3) => B"00000",
      S(2) => \i__carry_i_1_n_4\,
...
\read_addr[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"707F8F807F70808F"
    )
        port map (
      I0 => \col_cnt_reg_n_0_[2]\,
      I1 => \read_addr[3]_i_2_n_0\,
      I2 => data_out_ready1,
      I3 => \read_addr[3]_i_3_n_0\,
      I4 => \col_cnt_reg_n_0_[3]\,
      I5 => \read_addr[3]_i_4_n_0\,
...
\write_addr[10]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => \FSM_onehot_state_reg_n_0_[0]\,
      I2 => data_out_ready0,
      I3 => \write_addr[10]_i_2_n_0\,
      I4 => write_addr(10),
      O => \write_addr[10]_i_1_n_0\
    );
\write_addr[10]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F7FFFFFF"
    )
        port map (
...
\write_addr[11]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"CE0000CE"
    )
        port map (
...
\write_addr[11]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\write_addr[9]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"CE"
    )
        port map (
