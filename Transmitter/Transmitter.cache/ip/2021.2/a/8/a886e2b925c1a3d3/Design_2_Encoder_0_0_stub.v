...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(ldpc_core_clk, clk, reset, aresetn, data_in, 
  ...
  data_out, data_out_valid, core_finish, axis_data_count, current_code_rate, data_out_last)
/* synthesis syn_black_box black_box_pad_pin="ldpc_core_clk,clk,reset,aresetn,data_in[31:0],data_in_valid,din_ready_ifsm2enc,data_in_last,sel_FEC_code_rate[1:0],data_out_ready,data_out[31:0],data_out_valid,core_finish,axis_data_count[12:0],current_code_rate[1:0],data_out_last" */;
  input ldpc_core_clk;
  input clk;
  input reset;
  input aresetn;
