...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, reset, control_unit_din_data, 
  ...
  scrambler_control_enable, encoder_code_rate, interleaver_dout_valid, 
  interleaver_dout_data, interleaver_dout_last, interleaver_last_frame, 
  interleaver_din_ready, mapper_dout_ready, mapper_dout_last, mapper_last_frame, 
  mapper_selected_mod, mapper_din_data, mapper_din_valid, mapper_signal_field_enable, 
