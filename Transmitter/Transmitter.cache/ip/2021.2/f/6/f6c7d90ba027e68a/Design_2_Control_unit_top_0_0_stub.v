...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, reset, control_unit_din_data, 
  ...
  control_unit_last_frame, control_unit_enable, mod_cod_schemes, num_streams, ref_distance, 
  scrambler_init, num_words, start_tx, phy_src_address, phy_dest_address, 
  scrambler_dout_ready, scrambler_din_data, scrambler_seed, scrambler_din_valid, 
  scrambler_din_last, scrambler_control_enable, encoder_code_rate, 
  interleaver_dout_valid, interleaver_dout_data, interleaver_dout_last, 
  interleaver_last_frame, interleaver_din_ready, mapper_dout_ready, mapper_dout_last, 
  mapper_last_frame, mapper_selected_mod, mapper_din_data, mapper_din_valid, 
  mapper_signal_field_enable, mapper_end_of_frame, dpd_dout_ready, dpd_din_valid, 
  dpd_din_data_I, dpd_din_data_Q, multi_din_ready)
/* synthesis syn_black_box black_box_pad_pin="clk,reset,control_unit_din_data[31:0],control_unit_din_valid,control_unit_end_of_frame,control_unit_dout_ready,control_unit_last_frame,control_unit_enable,mod_cod_schemes[4:0],num_streams[4:0],ref_distance[7:0],scrambler_init[31:1],num_words[15:0],start_tx,phy_src_address[4:0],phy_dest_address[4:0],scrambler_dout_ready,scrambler_din_data[31:0],scrambler_seed[31:1],scrambler_din_valid,scrambler_din_last,scrambler_control_enable,encoder_code_rate[1:0],interleaver_dout_valid,interleaver_dout_data[31:0],interleaver_dout_last,interleaver_last_frame,interleaver_din_ready,mapper_dout_ready,mapper_dout_last,mapper_last_frame,mapper_selected_mod[2:0],mapper_din_data[5:0],mapper_din_valid,mapper_signal_field_enable,mapper_end_of_frame,dpd_dout_ready,dpd_din_valid,dpd_din_data_I[11:0],dpd_din_data_Q[11:0],multi_din_ready" */;
  input clk;
  input reset;
