...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Bit_splitter is
  ...
  signal data_out_ready_reg_i_4_n_0 : STD_LOGIC;
  signal data_out_ready_reg_i_4_n_1 : STD_LOGIC;
  signal data_out_ready_reg_i_4_n_2 : STD_LOGIC;
  signal data_out_ready_reg_i_4_n_3 : STD_LOGIC;
  signal data_out_ready_reg_i_4_n_4 : STD_LOGIC;
  signal data_out_ready_reg_i_4_n_5 : STD_LOGIC;
  signal data_out_ready_reg_i_4_n_6 : STD_LOGIC;
  signal data_out_ready_reg_i_4_n_7 : STD_LOGIC;
  ...
  signal \data_out_reg[5]_i_26_n_0\ : STD_LOGIC;
  ...
  signal \data_out_reg[5]_i_42_n_0\ : STD_LOGIC;
  signal \data_out_reg[5]_i_42_n_1\ : STD_LOGIC;
  signal \data_out_reg[5]_i_42_n_2\ : STD_LOGIC;
  signal \data_out_reg[5]_i_42_n_3\ : STD_LOGIC;
  signal \data_out_reg[5]_i_42_n_4\ : STD_LOGIC;
  signal \data_out_reg[5]_i_42_n_5\ : STD_LOGIC;
  signal \data_out_reg[5]_i_42_n_6\ : STD_LOGIC;
  signal \data_out_reg[5]_i_42_n_7\ : STD_LOGIC;
  ...
  signal NLW_data_out_ready_reg_i_4_O_UNCONNECTED : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal NLW_data_out_ready_reg_i_5_O_UNCONNECTED : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  signal \NLW_data_out_reg[5]_i_42_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute SOFT_HLUTNM of \data_out[1]_i_6\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \data_out[2]_i_3\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \data_out[3]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \data_out[3]_i_5\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \data_out[4]_i_19\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \data_out[4]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \data_out[4]_i_9\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \data_out[5]_i_11\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \data_out[5]_i_16\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \data_out[5]_i_21\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \data_out[5]_i_24\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \data_out[5]_i_35\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \data_out[5]_i_38\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \data_out[5]_i_39\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \data_out[5]_i_40\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \data_out[5]_i_51\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \data_out[5]_i_63\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of data_out_ready_i_3 : label is "soft_lutpair2";
  attribute COMPARATOR_THRESHOLD of data_out_ready_reg_i_4 : label is 11;
  attribute COMPARATOR_THRESHOLD of data_out_ready_reg_i_5 : label is 11;
  ...
  attribute COMPARATOR_THRESHOLD of \data_out_reg[5]_i_42\ : label is 11;
...
\data_out[5]_i_11\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"47"
    )
        port map (
...
\data_out[5]_i_13\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"000D"
    )
        port map (
...
\data_out[5]_i_16\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000045"
    )
        port map (
...
\data_out[5]_i_34\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
...
\data_out[5]_i_35\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\data_out[5]_i_36\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000020"
    )
        port map (
...
\data_out[5]_i_40\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"BA"
    )
        port map (
...
\data_out[5]_i_51\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0B"
    )
        port map (
...
\data_out[5]_i_52\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000080"
    )
        port map (
...
\data_out[5]_i_63\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"BA"
    )
        port map (
...
data_out_ready_i_10: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
data_out_ready_i_14: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
data_out_ready_i_15: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
data_out_ready_i_6: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
data_out_ready_i_8: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
data_out_ready_reg_i_4: unisim.vcomponents.CARRY8
     port map (
      CI => data_out_ready_reg_i_5_n_0,
      CI_TOP => '0',
      CO(7) => data_out_ready_reg_i_4_n_0,
      CO(6) => data_out_ready_reg_i_4_n_1,
      CO(5) => data_out_ready_reg_i_4_n_2,
      CO(4) => data_out_ready_reg_i_4_n_3,
      CO(3) => data_out_ready_reg_i_4_n_4,
      CO(2) => data_out_ready_reg_i_4_n_5,
      CO(1) => data_out_ready_reg_i_4_n_6,
      CO(0) => data_out_ready_reg_i_4_n_7,
      DI(7) => i_reg(31),
      DI(6 downto 0) => B"0000000",
      O(7 downto 0) => NLW_data_out_ready_reg_i_4_O_UNCONNECTED(7 downto 0),
      S(7) => data_out_ready_i_6_n_0,
      S(6) => data_out_ready_i_7_n_0,
      S(5) => data_out_ready_i_8_n_0,
      S(4) => data_out_ready_i_9_n_0,
      S(3) => data_out_ready_i_10_n_0,
      S(2) => data_out_ready_i_11_n_0,
      S(1) => data_out_ready_i_12_n_0,
...
data_out_ready_reg_i_5: unisim.vcomponents.CARRY8
     port map (
      ...
      DI(7 downto 2) => B"000000",
      DI(1) => data_out_ready_i_14_n_0,
      DI(0) => data_out_ready_i_15_n_0,
      O(7 downto 0) => NLW_data_out_ready_reg_i_5_O_UNCONNECTED(7 downto 0),
...
\data_out_reg[0]_i_6\: unisim.vcomponents.MUXF8
     port map (
...
\data_out_reg[5]_i_15\: unisim.vcomponents.CARRY8
     port map (
      ...
      S(7) => \data_out[5]_i_43_n_0\,
      S(6) => \data_out[5]_i_44_n_0\,
      S(5) => \data_out[5]_i_45_n_0\,
      S(4) => \data_out[5]_i_46_n_0\,
      S(3) => \data_out[5]_i_47_n_0\,
      S(2) => \data_out[5]_i_48_n_0\,
      S(1) => \data_out[5]_i_49_n_0\,
      S(0) => \data_out[5]_i_50_n_0\
    );
\data_out_reg[5]_i_26\: unisim.vcomponents.CARRY8
     port map (
      CI => \data_out[5]_i_53_n_0\,
      CI_TOP => '0',
      CO(7) => \data_out_reg[5]_i_26_n_0\,
...
\data_out_reg[5]_i_42\: unisim.vcomponents.CARRY8
     port map (
      CI => '0',
      CI_TOP => '0',
      CO(7) => \data_out_reg[5]_i_42_n_0\,
      CO(6) => \data_out_reg[5]_i_42_n_1\,
      CO(5) => \data_out_reg[5]_i_42_n_2\,
      CO(4) => \data_out_reg[5]_i_42_n_3\,
      CO(3) => \data_out_reg[5]_i_42_n_4\,
      CO(2) => \data_out_reg[5]_i_42_n_5\,
      CO(1) => \data_out_reg[5]_i_42_n_6\,
      CO(0) => \data_out_reg[5]_i_42_n_7\,
      DI(7 downto 2) => B"000000",
      DI(1) => \data_out[5]_i_65_n_0\,
      DI(0) => \data_out[5]_i_66_n_0\,
      O(7 downto 0) => \NLW_data_out_reg[5]_i_42_O_UNCONNECTED\(7 downto 0),
      S(7) => \data_out[5]_i_67_n_0\,
      S(6) => \data_out[5]_i_68_n_0\,
      S(5) => \data_out[5]_i_69_n_0\,
      S(4) => \data_out[5]_i_70_n_0\,
      S(3) => \data_out[5]_i_71_n_0\,
      S(2) => \data_out[5]_i_72_n_0\,
      S(1) => \data_out[5]_i_73_n_0\,
      S(0) => \data_out[5]_i_74_n_0\
    );
