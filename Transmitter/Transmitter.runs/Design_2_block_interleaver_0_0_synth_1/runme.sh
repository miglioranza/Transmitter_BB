...
HD_PWD='/home/miglioranza/Transmitter/Transmitter.runs/Design_2_block_interleaver_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Design_2_block_interleaver_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Design_2_block_interleaver_0_0.tcl
