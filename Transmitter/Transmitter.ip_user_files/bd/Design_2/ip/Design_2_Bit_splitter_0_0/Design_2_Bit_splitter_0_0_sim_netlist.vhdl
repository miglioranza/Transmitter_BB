...
-- Date        : Fri Mar 21 17:38:57 2025
-- Host        : uxsrv005 running 64-bit Red Hat Enterprise Linux release 8.10 (Ootpa)
-- Command     : write_vhdl -force -mode funcsim
--               /home/miglioranza/Transmitter/Transmitter.gen/sources_1/bd/Design_2/ip/Design_2_Bit_splitter_0_0/Design_2_Bit_splitter_0_0_sim_netlist.vhdl
...
entity Design_2_Bit_splitter_0_0_Bit_splitter is
  port (
  ...
  attribute ORIG_REF_NAME of Design_2_Bit_splitter_0_0_Bit_splitter : entity is "Bit_splitter";
end Design_2_Bit_splitter_0_0_Bit_splitter;

architecture STRUCTURE of Design_2_Bit_splitter_0_0_Bit_splitter is
  signal \^q\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal current_code : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal current_code0 : STD_LOGIC;
  signal \current_code[0]_i_1_n_0\ : STD_LOGIC;
  signal \current_code[0]_i_2_n_0\ : STD_LOGIC;
  signal \current_code[1]_i_1_n_0\ : STD_LOGIC;
  signal \current_code[1]_i_2_n_0\ : STD_LOGIC;
  ...
  signal data_out_ready_reg_i_25_n_0 : STD_LOGIC;
  signal data_out_ready_reg_i_25_n_1 : STD_LOGIC;
  signal data_out_ready_reg_i_25_n_2 : STD_LOGIC;
  signal data_out_ready_reg_i_25_n_3 : STD_LOGIC;
  signal data_out_ready_reg_i_25_n_4 : STD_LOGIC;
  signal data_out_ready_reg_i_25_n_5 : STD_LOGIC;
  signal data_out_ready_reg_i_25_n_6 : STD_LOGIC;
  signal data_out_ready_reg_i_25_n_7 : STD_LOGIC;
  ...
  signal NLW_data_out_ready_reg_i_25_O_UNCONNECTED : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute SYNTH_INFERRED of \current_code_reg[0]\ : label is std.standard.true;
  attribute SYNTH_INFERRED of \current_code_reg[1]\ : label is std.standard.true;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \data_out[1]_i_7\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \data_out[2]_i_10\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \data_out[2]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \data_out[2]_i_6\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \data_out[3]_i_10\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \data_out[4]_i_17\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \data_out[4]_i_6\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \data_out[4]_i_7\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \data_out[4]_i_8\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \data_out[5]_i_10\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \data_out[5]_i_12\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \data_out[5]_i_21\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of data_out_ready_i_10 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of data_out_ready_i_11 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of data_out_ready_i_12 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of data_out_ready_i_15 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of data_out_ready_i_16 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of data_out_ready_i_18 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of data_out_ready_i_19 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of data_out_ready_i_2 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of data_out_ready_i_7 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of data_out_ready_i_8 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of data_out_ready_i_9 : label is "soft_lutpair8";
  attribute COMPARATOR_THRESHOLD of data_out_ready_reg_i_20 : label is 11;
  attribute COMPARATOR_THRESHOLD of data_out_ready_reg_i_25 : label is 11;
  ...
  attribute SOFT_HLUTNM of data_out_valid_i_1 : label is "soft_lutpair4";
...
\current_code[0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      ...
      I0 => reset,
      I1 => code_rate(0),
      O => \current_code[0]_i_1_n_0\
    );
\current_code[0]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\current_code[1]_i_2\: unisim.vcomponents.LUT2
    generic map(
      ...
      I0 => reset,
      I1 => code_rate(1),
      O => \current_code[1]_i_2_n_0\
    );
\current_code_reg[0]\: unisim.vcomponents.FDCPE
    generic map(
      INIT => '0'
    )
        port map (
      C => clk,
      CE => current_code0,
      CLR => \current_code[0]_i_1_n_0\,
      D => code_rate(0),
      PRE => \current_code[0]_i_2_n_0\,
      Q => current_code(0)
    );
\current_code_reg[1]\: unisim.vcomponents.FDCPE
    generic map(
      INIT => '0'
    )
        port map (
      C => clk,
      CE => current_code0,
      CLR => \current_code[1]_i_1_n_0\,
      D => code_rate(1),
      PRE => \current_code[1]_i_2_n_0\,
      Q => current_code(1)
    );
\current_mode_type[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"28AAAA28"
    )
        port map (
...
\current_mode_type_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\current_mode_type_reg[1]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\current_mode_type_reg[2]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\data_out[5]_i_21\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FE0E"
    )
        port map (
      I0 => data_out_ready_i_21_n_0,
      I1 => \data_out_ready1_carry__0_n_0\,
      I2 => \^q\(0),
      I3 => data_out_ready_reg_i_20_n_0,
...
data_out_ready_i_12: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
data_out_ready_i_15: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
      I0 => data_out_ready_reg_i_20_n_0,
      I1 => \^q\(0),
      I2 => \^q\(1),
      O => data_out_ready_i_15_n_0
    );
data_out_ready_i_16: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0100"
    )
        port map (
...
data_out_ready_i_21: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0200000000000000"
        ...
        port map (
      I0 => data_out_ready_i_34_n_0,
      I1 => i(28),
      I2 => i(29),
      I3 => data_out_ready_i_17_n_0,
      I4 => data_out_ready_i_35_n_0,
      I5 => data_out_ready_i_19_n_0,
...
data_out_ready_i_35: unisim.vcomponents.LUT6
    generic map(
...
data_out_ready_i_5: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => data_out_ready_i_14_n_0,
      I3 => data_out_ready_i_15_n_0,
      I4 => data_out_ready_i_16_n_0,
      I5 => \^q\(2),
...
data_out_ready_reg_i_20: unisim.vcomponents.CARRY8
     port map (
      CI => data_out_ready_reg_i_25_n_0,
      CI_TOP => '0',
      ...
      S(7) => data_out_ready_i_26_n_0,
      S(6) => data_out_ready_i_27_n_0,
      S(5) => data_out_ready_i_28_n_0,
      S(4) => data_out_ready_i_29_n_0,
      S(3) => data_out_ready_i_30_n_0,
      S(2) => data_out_ready_i_31_n_0,
      S(1) => data_out_ready_i_32_n_0,
      S(0) => data_out_ready_i_33_n_0
    );
data_out_ready_reg_i_25: unisim.vcomponents.CARRY8
     port map (
      CI => '0',
      CI_TOP => '0',
      CO(7) => data_out_ready_reg_i_25_n_0,
      CO(6) => data_out_ready_reg_i_25_n_1,
      CO(5) => data_out_ready_reg_i_25_n_2,
      CO(4) => data_out_ready_reg_i_25_n_3,
      CO(3) => data_out_ready_reg_i_25_n_4,
      CO(2) => data_out_ready_reg_i_25_n_5,
      CO(1) => data_out_ready_reg_i_25_n_6,
      CO(0) => data_out_ready_reg_i_25_n_7,
      DI(7 downto 2) => B"000000",
      DI(1) => data_out_ready_i_36_n_0,
      DI(0) => data_out_ready_i_37_n_0,
      O(7 downto 0) => NLW_data_out_ready_reg_i_25_O_UNCONNECTED(7 downto 0),
      S(7) => data_out_ready_i_38_n_0,
      S(6) => data_out_ready_i_39_n_0,
      S(5) => data_out_ready_i_40_n_0,
      S(4) => data_out_ready_i_41_n_0,
      S(3) => data_out_ready_i_42_n_0,
      S(2) => data_out_ready_i_43_n_0,
      S(1) => data_out_ready_i_44_n_0,
      S(0) => data_out_ready_i_45_n_0
    );
...
\data_out_reg[5]_i_13\: unisim.vcomponents.CARRY8
     port map (
      ...
      DI(0) => \data_out[5]_i_24_n_0\,
      O(7 downto 0) => \NLW_data_out_reg[5]_i_13_O_UNCONNECTED\(7 downto 0),
      S(7) => \data_out[5]_i_25_n_0\,
      S(6) => \data_out[5]_i_26_n_0\,
      S(5) => \data_out[5]_i_27_n_0\,
      S(4) => \data_out[5]_i_28_n_0\,
      S(3) => \data_out[5]_i_29_n_0\,
      S(2) => \data_out[5]_i_30_n_0\,
      S(1) => \data_out[5]_i_31_n_0\,
      S(0) => \data_out[5]_i_32_n_0\
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Design_2_Bit_splitter_0_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
    mod_type : in STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  attribute NotValidForBitStream of Design_2_Bit_splitter_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of Design_2_Bit_splitter_0_0 : entity is "Design_2_Bit_splitter_0_0,Bit_splitter,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of Design_2_Bit_splitter_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of Design_2_Bit_splitter_0_0 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of Design_2_Bit_splitter_0_0 : entity is "Bit_splitter,Vivado 2021.2";
end Design_2_Bit_splitter_0_0;

architecture STRUCTURE of Design_2_Bit_splitter_0_0 is
...
begin
U0: entity work.Design_2_Bit_splitter_0_0_Bit_splitter
     port map (
      Q(2 downto 0) => mod_type2mapper(2 downto 0),
      clk => clk,
