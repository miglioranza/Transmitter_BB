...
#
# Generated by export_simulation on Thu Oct 24 14:48:29 CEST 2024
#
################################################################################
...
'-reset_run' switch to the './Polyphase_filter_tb.sh' script.

./Polyphase_filter_tb.sh -reset_run
...
./Polyphase_filter_tb.sh -noclean_files

For more information on the script, please type './Polyphase_filter_tb.sh -help'.
