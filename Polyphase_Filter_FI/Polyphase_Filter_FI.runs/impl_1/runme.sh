...
HD_PWD='/home/miglioranza/Polyphase_Filter_FI/Polyphase_Filter_FI.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Polyphase_filter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Polyphase_filter.tcl -notrace
