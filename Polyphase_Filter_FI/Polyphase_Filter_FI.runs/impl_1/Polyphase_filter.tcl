...
namespace eval ::optrace {
  variable script "/home/miglioranza/Polyphase_Filter_FI/Polyphase_Filter_FI.runs/impl_1/Polyphase_filter.tcl"
...
set rc [catch {
  ...
  open_checkpoint /home/miglioranza/Polyphase_Filter_FI/Polyphase_Filter_FI.runs/impl_1/Polyphase_filter.dcp
...
OPTRACE "Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force Polyphase_filter_opt.dcp
OPTRACE "Opt Design: write_checkpoint" END { }
OPTRACE "opt_design reports" START { REPORT }
  create_report "impl_1_opt_report_drc_0" "report_drc -file Polyphase_filter_drc_opted.rpt -pb Polyphase_filter_drc_opted.pb -rpx Polyphase_filter_drc_opted.rpx"
...
OPTRACE "Place Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force Polyphase_filter_placed.dcp
OPTRACE "Place Design: write_checkpoint" END { }
OPTRACE "place_design reports" START { REPORT }
  create_report "impl_1_place_report_io_0" "report_io -file Polyphase_filter_io_placed.rpt"
  create_report "impl_1_place_report_utilization_0" "report_utilization -file Polyphase_filter_utilization_placed.rpt -pb Polyphase_filter_utilization_placed.pb"
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file Polyphase_filter_control_sets_placed.rpt"
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force Polyphase_filter_physopt.dcp
...
OPTRACE "Route Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force Polyphase_filter_routed.dcp
OPTRACE "Route Design: write_checkpoint" END { }
OPTRACE "route_design reports" START { REPORT }
  create_report "impl_1_route_report_drc_0" "report_drc -file Polyphase_filter_drc_routed.rpt -pb Polyphase_filter_drc_routed.pb -rpx Polyphase_filter_drc_routed.rpx"
  create_report "impl_1_route_report_methodology_0" "report_methodology -file Polyphase_filter_methodology_drc_routed.rpt -pb Polyphase_filter_methodology_drc_routed.pb -rpx Polyphase_filter_methodology_drc_routed.rpx"
  create_report "impl_1_route_report_power_0" "report_power -file Polyphase_filter_power_routed.rpt -pb Polyphase_filter_power_summary_routed.pb -rpx Polyphase_filter_power_routed.rpx"
  create_report "impl_1_route_report_route_status_0" "report_route_status -file Polyphase_filter_route_status.rpt -pb Polyphase_filter_route_status.pb"
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -report_unconstrained -file Polyphase_filter_timing_summary_routed.rpt -pb Polyphase_filter_timing_summary_routed.pb -rpx Polyphase_filter_timing_summary_routed.rpx -warn_on_violation "
  create_report "impl_1_route_report_incremental_reuse_0" "report_incremental_reuse -file Polyphase_filter_incremental_reuse_routed.rpt"
  create_report "impl_1_route_report_clock_utilization_0" "report_clock_utilization -file Polyphase_filter_clock_utilization_routed.rpt"
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file Polyphase_filter_bus_skew_routed.rpt -pb Polyphase_filter_bus_skew_routed.pb -rpx Polyphase_filter_bus_skew_routed.rpx"
...
if {$rc} {
  write_checkpoint -force Polyphase_filter_routed_error.dcp
